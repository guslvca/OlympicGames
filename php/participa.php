...
<html>
    ...
    $resultsql = "SELECT TIPO_OLIMP,ANO_OLIMP,NOME_ESPORTE,MODALIDADE FROM participa LIMIT 1000";
    ...
    if($result->num_rows > 0){
        ...
        <tr><th>OLYMPIC TYPE</th><th>OLYMPIC YEAR</th><th>SPORT NAME</th>
        <th>MODALIDADE</th>
        ...
        while($row = mysqli_fetch_assoc($result)){
            echo "<tr><td>".$row["TIPO_OLIMP"]."</td><td>".$row["ANO_OLIMP"]."</td><td>".$row["NOME_ESPORTE"]."</td>
