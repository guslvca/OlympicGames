...
<html>
    ...
    $resultsql = "SELECT NOME_PAIS,ABREVIACAO_PAIS,POPULACAO,PIB_PERCAPITA,BANDEIRA FROM pais LIMIT 1000";
    ...
    if($result->num_rows > 0){
        ...
        <tr><th>NOME DO PAIS</th><th>ABREVIAÇÃO PAIS</th><th>POPULAÇÃO</th>
        <th>PIB PER CAPITAL</th>
        <th>BANDEIRA</th>
        ...
        while($row = mysqli_fetch_assoc($result)){
            echo "<tr><td>".$row["NOME_PAIS"]."</td><td>".$row["ABREVIACAO_PAIS"]."</td><td>".$row["POPULACAO"]."</td>
            <td>".$row["PIB_PERCAPITA"]."</td>
            <td>".$row["BANDEIRA"]."</td>
