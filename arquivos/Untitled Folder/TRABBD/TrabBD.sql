...
ABREVIACAO_PAIS char(3),   
POPULACAO int, 
PIB_PERCAPITA float,
BANDEIRA blob,
primary key (ABREVIACAO_PAIS));
...
PAIS_ORIGEM char(3),
TECNICO varchar(255),
PREPARADOR_FISICO varchar(255),
primary key (NOME),
foreign key (PAIS_ORIGEM) references PAIS(ABREVIACAO_PAIS) );

create table ESPORTE
(NOME_ESPORTE varchar(255),
MODALIDADE varchar(255),
TIPO_LOCAL varchar(255),
primary key (NOME_ESPORTE,MODALIDADE));

create table ATLETAESPORTE
( NOME_ATLETA varchar(255) default 'blk',
NOME_ESPORTE varchar(255) default 'blk',
MODALIDADE varchar(255) default 'blk',
MEDALHA varchar(6),
foreign key (NOME_ATLETA) references ATLETA(NOME),
foreign key (NOME_ESPORTE) references ESPORTE(NOME_ESPORTE),
primary key (NOME_ATLETA, NOME_ESPORTE, MODALIDADE) );
...
(TIPO_OLIMP varchar(6) default 'blk',
ANO_OLIMP int(4),
NOME_ESPORTE varchar(255) default 'blk',
MODALIDADE varchar(255) default 'blk',
primary key (TIPO_OLIMP,ANO_OLIMP,NOME_ESPORTE,MODALIDADE),
foreign key (NOME_ESPORTE) references ESPORTE(NOME_ESPORTE), 
foreign key (ANO_OLIMP) references OLIMPIADA(ANO) );

/* MASCOTE COMO PK DA ERRO POR SER DO DOMINIO BLOB */
create table MASCOTE
(ANO_OLIMP_MASCOTE int(4),
TIPO_OLIMP_MASCOTE varchar(6),
MASCOTES blob,
primary key (ANO_OLIMP_MASCOTE,TIPO_OLIMP_MASCOTE),
foreign key (ANO_OLIMP_MASCOTE) references OLIMPIADA(ANO) );

create table SEDE
( ANO_OLIMP int(4),
TIPO_OLIMP varchar(6),
PAIS_SEDE char(3) default 'blk',
primary key (ANO_OLIMP, PAIS_SEDE,TIPO_OLIMP),
foreign key (PAIS_SEDE) references PAIS(ABREVIACAO_PAIS), 
foreign key (ANO_OLIMP) references OLIMPIADA(ANO) );

/*INSERI USANDO ESSES COMANDOS PQ PELO IMPORT TAVA DANDO PROBLEMAS, NAO IMPORTAVA TODOS OS PAISES*/
INSERT INTO PAIS (nome_pais, abreviacao_pais, populacao, pib_percapita) VALUES
('Afghanistan','AFG',32526562,594.323081219966),
    ...
    ('British Virgin Islands','IVB',30117,NULL),
    ...
    ('Libya','LBA',6278438,NULL),
    ('Liechtenstein','LIE',37531,NULL),
    ...
    ('Netherlands Antilles*','AHO',NULL,NULL),
    ...
    ('Palestine, Occupied Territories','PLE',NULL,NULL),
    ('Panama','PAN',3929141,13268.1137549335),
    ('Papua New Guinea','PNG',7619321,NULL),
    ...
    ('Syria','SYR',18502413,NULL),
    ('Taiwan','TPE',NULL,NULL),
    ...
    ('Venezuela','VEN',31108083,NULL),
    ('Vietnam','VIE',91703800,2111.13802366815),
    ('Virgin Islands*','ISV',103574,NULL),
    ('Yemen','YEM',26832215,1406.2916511457),
    ('Zambia','ZAM',16211767,1304.87901447726),
    ('Zimbabwe','ZIM',15602751,924.143819253412);


/* AQUI É A INSERCAO DE TODOS OS PAISES QUE NAO EXISTEM MAIS, MAS QUE PARTICIPARAM NAS OLIMPIADAS PASSADAS
	OU PAISES QUE MUDARAM SUA ABREVIACAO COM O TEMPO*/
INSERT INTO PAIS (nome_pais, abreviacao_pais, populacao, pib_percapita) VALUES
('Yugoslavia', 'YUG', NULL, NULL),
('Union Of Soviet Socialist Republics', 'URS', NULL, NULL),
('Equipes Mistas', 'ZZX', NULL, NULL),
('Australasia','ANZ', NULL, NULL),
('Bohemia','BOH', NULL, NULL),
('British West Indies','BWI', NULL, NULL),
('United Team of Germany','EUA', NULL, NULL),
('Unified Team','EUN', NULL, NULL),
('West Germany','FRG', NULL, NULL),
('East Germany','GDR', NULL, NULL),
('Russian Empire','RU1', NULL, NULL),
('Czechoslovakia','TCH', NULL, NULL),
('Holland','HOL', NULL, NULL),
('Independent Olympic Participants','IOP', NULL, NULL);

INSERT INTO PAIS (nome_pais, abreviacao_pais, populacao, pib_percapita) VALUES
('Trinidad and Tobago atual','TTO', NULL, NULL),
('Romania atual','ROU', NULL, NULL),
('Singapore atual','SGP', NULL, NULL),
('Serbia atual','SRB', NULL, NULL);
